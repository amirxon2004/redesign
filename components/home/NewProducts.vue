<template>
    <section class="w-full flex justify-center p-8" v-if="products && products.length">
        <div class="f-container">
            <div class="flex justify-between mb-4 items-start gap-2">
                <div>
                    <h1 class="text-gray-700 text-2xl font-extrabold">Yangi maxsulotlar</h1> 
                </div> 
...
const { data:products } = await useAsyncData('get-new-products', async () => {
    try {
