        ...
        <div class="w-full">
            ...
            <div class="w-full flex justify-center flex-col items-center p-8 align-top ">
                <div class="f-container mb-[1.5rem]">
                    ...
                    <el-breadcrumb-item><nuxt-link to="/info" class="bread-link">Вопросы и ответы</nuxt-link></el-breadcrumb-item>
                </el-breadcrumb>
                </div>
                <div class="f-container flex gap-[1.5rem] items-start justify-start">
